...
import static org.netbeans.modules.php.symfony.project.ComposerPackages.COMPOSER_FILENAME;
...
public class SymfonyPluginProvider {
    ...
    public SymfonyPluginProvider(FileObject projectDir) {
    ...
    public static LookupProvider createJavaBaseProvider() {
        return new LookupProvider() {
            ...
            public Lookup createAdditionalLookup(Lookup baseContext) {
                ...
                return Lookups.fixed(new SymfonyPluginProvider(project.getProjectDirectory())
                );
            }
        };
    }
