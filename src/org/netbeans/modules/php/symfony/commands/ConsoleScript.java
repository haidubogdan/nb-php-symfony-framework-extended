...
public class ConsoleScript {
    ...
    public static final String SCRIPT_NAME = "bin/console"; // NOI18N
    ...
    private final String binConsolePath;

    private ConsoleScript(String binConsolePath) {
        this.binConsolePath = binConsolePath;
    }

    @CheckForNull
    public static ConsoleScript forPhpModule(PhpModule phpModule, boolean warn) {
        ...
        if (error == null) {
            return new ConsoleScript(artisanPath);
        }
        if (warn) {
    ...
    public static String validate(String command) {
        return PhpExecutableValidator.validateCommand(command, "Symfony bin/console"); // NOI18N
    }
    ...
    private PhpExecutable createExecutable(PhpModule phpModule) {
        return new PhpExecutable(binConsolePath)
