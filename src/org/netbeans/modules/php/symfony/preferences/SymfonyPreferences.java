 ...
 */
package org.netbeans.modules.php.symfony.preferences;
...
public final class SymfonyPreferences {
    ...
    private static final String ENABLED = "symfony_enabled"; // NOI18N
    ...
    private SymfonyPreferences(PhpModule module) {
    ...
    public static SymfonyPreferences fromPhpModule(PhpModule module) {
        return new SymfonyPreferences(module);
    }
}
