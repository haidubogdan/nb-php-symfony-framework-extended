...
public class ProjectUtils {
    ...
    public static boolean isInSymfonyModule(Document doc) {
        ...
        return isInSymfonyModule(module);
    }

    public static boolean isInSymfonyModule(PhpModule module) {
        return SymfonyPreferences.fromPhpModule(module).isEnabled();
    }
