 ...
 */
package org.netbeans.modules.php.symfony.utils;
...
public class PathUtils {
    ...
    public static final String SYMFONY_TEMPLATES_PATH = "templates"; //NOI18N
    public static final String TWIG_EXT = ".html.twig"; //NOI18N
    ...
    public static String toBladeViewPath(String filePath) {
        return filePath.replace(TWIG_EXT, "").replace(SLASH, DOT);
    }

    public static String viewPathToFilePath(String viewPath) {
        return viewPath.replace(DOT, SLASH) + TWIG_EXT;
    }

    public static HashSet<FileObject> getDefaultRoots(Project project) {
        HashSet<FileObject> defaultList = new HashSet<>();
        FileObject defaultViewsRoot = project.getProjectDirectory().getFileObject(SYMFONY_TEMPLATES_PATH);
