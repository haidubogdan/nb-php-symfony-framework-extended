...
public final class SymfonyUtils {
    ...
    public static final String DIR_VIEWS = "templates"; // NOI18N
    public static final String CONFIG_METHOD = "config"; // NOI18N
    public static final String VIEW_METHOD = "render"; // NOI18N
    ...
    public static boolean isView(FileObject fo) {
        ...
        return DIR_VIEWS.equals(fileDir) && fo.getNameExt().endsWith(PathUtils.TWIG_EXT);
    }
